...
QT_MOC_LITERAL(1, 6, 15), // "recevie_success"
QT_MOC_LITERAL(2, 22, 0), // ""
QT_MOC_LITERAL(3, 23, 3), // "img"
QT_MOC_LITERAL(4, 27, 22), // "processPendingDatagram"
QT_MOC_LITERAL(5, 50, 5) // "close"

    },
    "video\0recevie_success\0\0img\0"
    "processPendingDatagram\0close"
};
...
void video::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (video::*)(QImage );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&video::recevie_success)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void video::recevie_success(QImage _t1)
{
